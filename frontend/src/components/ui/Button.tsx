  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        variant === 'primary' && 'bg-gradient-to-b from-amber-400 to-amber-500 text-[#0c0f14] font-semibold shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 hover:from-amber-300 hover:to-amber-400',
        variant === 'secondary' && 'bg-white/[0.06] text-[#8b95a8] border border-white/[0.08] hover:bg-white/[0.1] hover:text-[#f0f2f5]',
