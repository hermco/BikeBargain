          ...
          >
            {suggestions.map((s, i) => (
              <button
                ...
                className="w-full text-left px-3 py-2.5 text-sm text-text-secondary hover:bg-tint/[0.06] hover:text-text-primary transition-colors flex items-center gap-2.5 border-b border-tint/[0.04] last:border-0"
              >
